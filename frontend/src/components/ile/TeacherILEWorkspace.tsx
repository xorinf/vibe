  ...
  return (
    <div className="flex h-full min-h-0 flex-col bg-white">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              ...
              {isDirty ? (
                ...
                <span className="inline-flex shrink-0 items-center gap-0.5 rounded-full bg-emerald-50 px-1.5 py-0.5 text-[10px] font-medium text-emerald-700">
          ...
          {saved?._id ? (
            ...
            >
              ...
              {saved.currentVersion > 0 && (
                <span className="rounded-full bg-slate-100 px-1 text-[10px] font-medium text-slate-600">
      ...
      <Dialog open={aiConfigOpen} onOpenChange={setAiConfigOpen}>
        <DialogContent
          className="h-[min(640px,90vh)] w-[min(560px,95vw)] gap-0 overflow-hidden border-slate-200 bg-white p-0 [&>button:has(>span.sr-only)]:hidden"
        >
