...
export function AssetAttachments({
  ...
  return (
    <div
      className={cn(
        'flex flex-wrap items-center gap-1.5 border-b border-slate-200 bg-violet-50/40 px-3 py-2',
        className,
      )}
    >
...
function AttachedChip({
  ...
  return (
    <span className="inline-flex items-center gap-1 rounded-full border border-violet-200 bg-white py-0.5 pl-2 pr-1 text-[10px] text-slate-700">
      <a
        href={asset.url}
        target="_blank"
