      ...
      <header className="flex items-center justify-between border-b border-slate-800 bg-slate-900/80 px-5 py-3 backdrop-blur">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-400">Interactive learning experience</p>
          </div>
        </div>
...
function LoadingState({ onCancel }: { onCancel: () => void }) {
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-white text-sm text-slate-500">
      <div className="flex items-center gap-2">
