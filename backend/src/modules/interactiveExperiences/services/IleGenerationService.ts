...
- FILL THE WHOLE SCREEN — design for one-screen viewing, no scrolling.
  Use viewport units (\`vh\`, \`vw\`, \`dvh\`, \`dvw\`), set \`width:100\%;
  height:100dvh\` on \`<body>\`, and lay out content with flex/grid
  that adapts to aspect ratio (a 13" laptop vs a portrait phone
  should both see the whole experience). If the teacher has to
  scroll to discover the next interaction, the design failed.
